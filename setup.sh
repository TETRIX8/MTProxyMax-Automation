...
sshpass -e ssh -o StrictHostKeyChecking=no "$REMOTE_USER@$REMOTE_IP" "curl -sL https://raw.githubusercontent.com/TETRIX8/MTProxyMax-Automation/main/install_automation.sh | bash"
